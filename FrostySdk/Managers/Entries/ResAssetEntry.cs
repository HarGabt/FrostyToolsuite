namespace FrostySdk.Managers.Entries
{
    public enum ResourceType : uint
    {
        ...
        FBMorphBlendsResource = 0x675FA1B1,
        FBMorphTargetMeshResource = 0xAF105CA1,
        ...
        GpuDeformAdjacencyResource = 0x456CE4E6,
        GpuDeformBaseMeshSubsetResource = 0xED27DBDA,
        GpuDeformMeshWrapResource = 0xF17DDABD,
        GtsoLut = 0xCB8BCD07,
